            ...
            <div class="container">
                <div class="col-lg-12" style="padding-top: 50px; padding-bottom: 150px;">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-6 text-center mb-10" style="background-color:darkCyan;padding-bottom:100px;padding-top:100px;padding-left:20px;padding-right:20px">
                            <p class="text-white text-center" style="margin-top:0px;margin-bottom:30px">Sistem Pendukung Keputusan Kelayakan Penerima Bantuan Program Bedah Kemiskinan Rakyat Sejahtera
